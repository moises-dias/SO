...
// result < 0: erro
// result = 0: disco livre (disponível para comandos de leitura/escrita)
// result = 1: disco ocupado realizando leitura (disco nao disponivel)
// result = 2: disco ocupado realizando escrita (disco nao disponivel)
